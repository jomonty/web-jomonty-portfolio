    ...
    return (
            <nav>
                ...
                <ul>
                    <li>
                        <a 
                            href="https://github.com/jomonty" 
                            target="_blank"
                            rel="noreferrer"
                            data-tooltip="@jomonty's GitHub"
                    ...
                    <li>
                        <a 
                            ...
                            target="_blank"
                            rel="noreferrer"
                            data-tooltip="Josh Montgomery's LinkedIn"
                            data-placement="bottom">
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewPort="0 0 32 32">
                    ...
                    <li>
                        <a 
                            href="mailto:jomonty_cs@outlook.com" 
                            data-tooltip="Email Josh Montgomery"
                            data-placement="bottom">
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewPort="0 0 32 32">
